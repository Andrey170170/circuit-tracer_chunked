...
def resolve_nnsight_session_controls(
    *,
    ...
    validate_nnsight_session_control_requests(
        ...
        phase4_execution_batch_max_rows=phase4_execution_batch_max_rows,
    )
    requested = {
        "nnsight_session_capacity": nnsight_session_capacity,
        "phase3_compute_microbatch_max_rows": phase3_compute_microbatch_max_rows,
    ...
    phase4_rows = (
        ...
        if phase4_execution_batch_max_rows is None
        else phase4_execution_batch_max_rows
    )
    if phase3_rows > capacity or phase4_rows > capacity:
        name, value = (
            ("phase3_compute_microbatch_max_rows", phase3_rows)
            if phase3_rows > capacity
            else ("phase4_execution_batch_max_rows", phase4_rows)
        )
        raise ValueError(
    ...
    metadata: dict[str, object] = {
        "schema_version": 2,
        "compatibility_translation": "nnsight_session_controls_v2",
        ...
        "requested_phase4_execution_batch_max_rows": phase4_execution_batch_max_rows,
        "effective_phase4_execution_batch_max_rows": int(phase4_rows),
    }
