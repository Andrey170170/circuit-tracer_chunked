...
def test_phase0_decoder_range_diagnostics_survive_refresh_and_packaging() -> None:
    flattened = _decoder_row_execution_metadata(
        {
            ...
            "phase0_decoder_row_ranges_backend_request_count": 3,
    ...
    assert packaged["phase0_decoder_row_ranges"] == {
        ...
        "occurrence_row_count": 0,
        "mapping_count": 0,
        "block_count": 0,
        "read_count": 0,
        "backend_request_count": 3,
        "page_span_bytes": 0,
        "backend_requested_bytes": 0,
        "backend_materialized_bytes": 0,
        "planned_overfetch_ratio": 0.0,
        "physical_read_estimate_bytes": None,
        "fault_read_seconds": 0.0,
        "reorder_seconds": 0.0,
        "h2d_seconds": 0.0,
        "total_seconds": 0.0,
        "occurrence_row_bytes": 0,
        "mapping_open_count": 0,
        "range_count": 0,
        "output_bytes": 0,
        "temporary_staging_high_water_bytes": 0,
    }
